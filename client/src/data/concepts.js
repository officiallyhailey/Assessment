...
export const CONCEPTS = {
    ...
    setAnimals: "Updates the stored animals. Calling it re renders the component.",
    setAnimal: "Updates the single stored animal and re renders the component.",
...
export const NAMES = {
    ...
    population: "How many are estimated to exist. A number, so it can be sorted.",
    animal_id: "Holds an id from the animals table, linking a sighting to an animal.",
    spotted_on: "The date a sighting happened.",
    notes: "Optional free text about a sighting.",
    addOneAnimal: "The helper that runs the INSERT and returns the saved row.",
    getAllAnimals: "The helper that reads every animal out of the database.",
    getOneAnimal: "The helper that reads a single animal by its id.",
    updateAnimal: "The helper that changes an existing animal.",
    deleteAnimal: "The helper that removes an animal.",
    getAnimals: "The function in this component that fetches the list.",
    AnimalList: "The component that fetches the animals and puts them on screen.",
    animal: "One animal from the list, while it is being turned into a list item.",
    newAnimal: "The animal being sent to the server to be saved.",
    saved: "The animal the server sent back, now with the id it was given.",
    ...
    Lion: "One of the three animals in this example.",
    Penguin: "One of the three animals in this example.",
    Eagle: "One of the three animals in this example.",
    data: "The response body once it has been read, now usable as real data.",
    addAnimal: "The function in this file that sends the POST request.",
